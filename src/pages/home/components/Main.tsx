    ...
    return (
        <main className='w-full min-h-screen'>
            <section className='w-full h-screen flex flex-col items-center mt-10 text-white font-bold gap-10 sm:gap-30 md:gap-5'>
                <h1 className='text-white block text-2xl w-80 font-bold text-center ::before sm:hidden'>
                    LA TIENDA PARA LOS AMANTES DE LOS CARROS
                </h1>
                <button className='border border-[#DD0000] w-76 py-3 px-5 text-xl cursor-pointer hover:bg-[#DD0000] transition duration-500 sm:w-90 md:text-2xl md:w-auto'>
