...
import ShoppingCartMenu from "../../ui/ShoppingCartMenu";

const MainHeader = () => {
  const [isOpenHamburguerMenu, setIsOpenHamburguerMenu] =
    useState<boolean>(false);

  const [isOpenShoppingCartMenu, setIsOpenShoppingCartMenu] =
    useState<boolean>(false);
